...
{
    internal class CLCEventual : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "CONTRATO DE TRABAJO DE DURACION DETERMINADA", "A TIEMPO COMPLETO", "EVENTUAL POR CIRCUNSTANCIAS DE LA PRODUCCIÓN" };
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private int pagesPerDocument = 2;
        /// <summary>
        /// Constructor de la clase CLCEventual.
        /// </summary>
        ...
        public CLCEventual(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
            TipoDocumento = TipoDocumento.CLCEventual;
        }
