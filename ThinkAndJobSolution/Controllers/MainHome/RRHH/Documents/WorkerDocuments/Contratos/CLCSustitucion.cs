...
{
    internal class CLCSustitucion : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "CONTRATO DE TRABAJO DE DURACION DETERMINADA", "A TIEMPO COMPLETO", "INTERINIDAD" };
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private int pagesPerDocument = 2;
        /// <summary>
        /// Constructor de la clase CLCSustitucion.
        /// </summary>
        ...
        public CLCSustitucion(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
            TipoDocumento = TipoDocumento.CLCSustitucion;
        }
