...
{
    internal class CLTraIndefinido : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "TRANSFORMACION A INDEFINIDO" };
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private int pagesPerDocument = 2;
        /// <summary>
        /// Constructor de la clase CLTraIndefinido.
        /// </summary>
        ...
        public CLTraIndefinido(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
            TipoDocumento = TipoDocumento.CLTraIndefinido;
        }
