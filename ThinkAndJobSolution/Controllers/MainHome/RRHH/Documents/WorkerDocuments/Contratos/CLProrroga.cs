...
{
    internal class CLProrroga : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "COMUNICACION PRORROGA CONTRATO DE TRABAJO" };
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private int pagesPerDocument = 1;
        /// <summary>
        /// Constructor de la clase CLProrroga.
        /// </summary>
        ...
        public CLProrroga(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
            TipoDocumento = TipoDocumento.CLProrroga;
        }
