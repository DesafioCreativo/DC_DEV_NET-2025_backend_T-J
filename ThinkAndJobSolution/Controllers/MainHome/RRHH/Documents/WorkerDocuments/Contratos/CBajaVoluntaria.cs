...
{
    internal class CBajaVoluntaria : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "PETICION DE BAJA VOLUNTARIA" };
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private int pagesPerDocument = 1;
        /// <summary>
        /// Constructor de la clase CBajaVoluntaria.
        /// </summary>
        ...
        public CBajaVoluntaria(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
            TipoDocumento = TipoDocumento.CBajaVoluntaria;
        }
