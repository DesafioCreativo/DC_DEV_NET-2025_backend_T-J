...
{
    internal class CLCSustitucionParcial : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "CONTRATO DE TRABAJO DE DURACION DETERMINADA", "A TIEMPO PARCIAL", "INTERINIDAD" };
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private int pagesPerDocument = 2;
        /// <summary>
        /// Constructor de la clase CLCSustitucionParcial.
        /// </summary>
        ...
        public CLCSustitucionParcial(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
            TipoDocumento = TipoDocumento.CLCSustitucionParcial;
        }
