...
{
    internal class CLCFijoDiscontinuo : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "CONTRATO DE TRABAJO DE DURACION INDEFINIDA" };
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private int pagesPerDocument = 2;
        /// <summary>
        /// Constructor de la clase CLCFijoDiscontinuo.
        /// </summary>
        ...
        public CLCFijoDiscontinuo(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
            TipoDocumento = TipoDocumento.CLCFijoDiscontinuo;
        }
