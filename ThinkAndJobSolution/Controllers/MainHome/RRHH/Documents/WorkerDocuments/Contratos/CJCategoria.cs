...
{
    internal class CJCategoria : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "RELACIÓN LABORAL", "LLEVAR A CABO MODIFICACIÓN" };
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private int pagesPerDocument = 1;
        /// <summary>
        /// Constructor de la clase CJCategoria.
        /// </summary>
        ...
        public CJCategoria(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
            TipoDocumento = TipoDocumento.CJCategoria;
        }
