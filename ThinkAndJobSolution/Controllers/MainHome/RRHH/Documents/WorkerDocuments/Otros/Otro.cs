...
namespace ThinkAndJobSolution.Controllers.MainHome.RRHH.Documents.WorkerDocuments.Otros
{
    internal class Otro : PDF
    {
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private int pagesPerDocument = 1;
        public Otro(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) :
            base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        { }
