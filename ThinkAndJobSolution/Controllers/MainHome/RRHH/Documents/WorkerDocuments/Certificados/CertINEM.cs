...
namespace ThinkAndJobSolution.Controllers.MainHome.RRHH.Documents.WorkerDocuments.Certificados
{
    internal class CertINEM : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "CERTIFICADO DE EMPRESA" };
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private readonly int pagesPerDocument = 1;
        /// <summary>
        /// Constructor de la clase CertINEM.
        /// </summary>
        ...
        public CertINEM(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
            TipoDocumento = TipoDocumento.CertINEM;
        }
