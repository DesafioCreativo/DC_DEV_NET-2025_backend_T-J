...
namespace ThinkAndJobSolution.Controllers.MainHome.RRHH.Documents.WorkerDocuments.NominasYFiniquitos
{
    internal class Finiquito : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "LIQUIDACIÓN Y PAGO FINAL DE CUANTAS CANTIDADES" };
        /// <summary>
        /// Número de páginas por documento.
        /// </summary>
        private int pagesPerDocument = 1;
        /// <summary>
        /// Constructor de la clase Finiquito.
        /// </summary>
        ...
        public Finiquito(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
            TipoDocumento = TipoDocumento.Finiquito;
        }
        /// <summary>
        /// 
        /// </summary>
