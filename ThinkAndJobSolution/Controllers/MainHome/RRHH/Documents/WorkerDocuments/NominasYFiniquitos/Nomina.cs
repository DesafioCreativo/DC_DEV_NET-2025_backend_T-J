...
{
    internal class Nomina : PDF
    {
        /// <summary>
        /// Discriminantes del documento.
        /// </summary>
        public static string[] DISCRIMINANTE = { "CONCEPTOS", "UNIDADES", "DEVENGOS", "DEDUCCIONES" };
        /// <summary>
        ...
        public Nomina(string filename, string newDirectory, bool postProcessing, ref int index, ref PdfDocument mainDoc) : base(filename, newDirectory, postProcessing, ref index, ref mainDoc)
        {
