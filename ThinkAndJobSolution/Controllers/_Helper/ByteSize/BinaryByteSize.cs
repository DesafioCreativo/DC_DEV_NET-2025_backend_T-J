...
namespace ByteSizeLib
{
    public partial struct ByteSize
    {
        ...
        public const string KibiByteSymbol = "KB";

        /// <summary>Mebibyte symbol.</summary>
        public const string MebiByteSymbol = "MB";

        /// <summary>Gibibyte symbol.</summary>
        public const string GibiByteSymbol = "GB";

        /// <summary>Tebibyte symbol.</summary>
        public const string TebiByteSymbol = "TB";

        /// <summary>Pebibyte symbol.</summary>
        public const string PebiByteSymbol = "PB";
